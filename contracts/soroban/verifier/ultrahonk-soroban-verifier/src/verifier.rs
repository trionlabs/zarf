...
impl UltraHonkVerifier {
    ...
    pub fn expected_proof_bytes(&self) -> usize {
        proof_bytes_for_log_n(self.vk.log_circuit_size as usize)
    }
    ...
    pub fn verify(
        ...
        if proof_bytes.len() as usize != self.expected_proof_bytes() {
        ...
        let mut t = generate_transcript(
            ...
            &self.vk.vk_hash,
            pis_total,
            self.vk.log_circuit_size as usize,
        );

...
<div
    class="h-full border border-zen-border rounded-3xl overflow-hidden relative min-h-[400px] bg-zen-bg/50"
>
    <!-- Header -->
    <div class="p-8 border-b border-zen-border-subtle bg-zen-bg">
        {#if details}
            <div class="flex items-center gap-5">
                ...
                <div class="flex-1 min-w-0">
                    <div class="flex items-center gap-3 flex-wrap">
                        ...
                        <span
                            class="px-2 py-0.5 rounded-md bg-zen-fg/10 font-mono text-xs opacity-80"
                        >
                            {details.tokenSymbol}
                        </span>
                        <div
                            class="flex items-center gap-1 text-zen-success text-xs font-medium px-2 py-0.5 bg-zen-success/10 rounded-full"
                        >
                            <svg
                    ...
                    <div class="flex items-center gap-2 mt-1.5">
                        ...
                        <div
                            class="font-mono text-sm text-zen-fg-muted truncate max-w-[300px]"
        ...
        {:else}
            <div class="flex items-center gap-4 animate-pulse">
                <div class="w-14 h-14 rounded-full bg-zen-fg/10"></div>
                <div class="space-y-2">
                    <div class="h-5 w-32 bg-zen-fg/10 rounded"></div>
                    <div class="h-4 w-48 bg-zen-fg/10 rounded"></div>
                </div>
            </div>
        {/if}
    </div>
        ...
        >
            <div class="flex justify-between items-center">
                <div class="space-y-2">
                    ...
                    <div class="h-8 w-32 bg-zen-fg rounded"></div>
                </div>
                <div class="h-12 w-24 bg-zen-fg rounded-xl"></div>
            </div>
            <div class="h-32 bg-zen-fg/10 rounded-xl"></div>
            <div class="flex justify-between items-center">
                <div class="h-4 w-48 bg-zen-fg rounded"></div>
                <div class="h-4 w-12 bg-zen-fg rounded"></div>
            </div>
        </div>
        ...
        {#if !isAuthenticated}
            ...
            >
                ...
                >
                    ...
                    <div
                        class="text-left text-sm p-4 rounded-xl border border-zen-primary/10 bg-zen-primary/5 text-zen-fg-muted flex gap-4"
                    >
                        <div
                            class="w-8 h-8 rounded-full bg-zen-primary/10 flex items-center justify-center shrink-0 text-zen-primary"
                        >
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                class="w-4 h-4"
                    ...
                    <ZenButton
                        variant="primary"
                        class="w-full shadow-[var(--zen-shadow-md)] shadow-zen-primary/10 hover:shadow-[var(--zen-shadow-lg)] hover:shadow-zen-primary/20"
                        onclick={handleLogin}
                    >
                        <!-- Google G Icon - Simplified -->
                        <div
                            class="w-5 h-5 bg-zen-bg rounded-full flex items-center justify-center mr-2"
                        >
        ...
        {#if isAuthenticated}
            ...
            >
                ...
                >
                    ...
                    <p class="text-zen-fg-muted mb-6 max-w-xs mx-auto">
                        You can now proceed to check your eligible allocations.
                    </p>

                    <a
                        href={`/claim?address=${contractAddress}`}
                        class="inline-flex items-center justify-center px-8 py-3 rounded-xl bg-zen-primary text-zen-primary-content font-medium shadow-[var(--zen-shadow-md)] shadow-zen-primary/10 hover:shadow-[var(--zen-shadow-lg)] hover:shadow-zen-primary/20 transition-all"
                    >
                        Continue to Claim
                        <svg
                            xmlns="http://www.w3.org/2000/svg"

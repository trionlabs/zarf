...
>
    <span class="text-xs uppercase tracking-wider text-zen-fg-subtle font-medium mb-3"
        >Cliff Period Active</span
    >
    <div class="text-4xl font-mono font-light text-zen-fg tracking-tight">
        {timeLeft}
    </div>
    <span class="text-xs text-zen-fg-subtle font-light mt-2">until tokens start unlocking</span>
</div>

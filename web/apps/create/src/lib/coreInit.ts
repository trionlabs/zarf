...
const ENV: Readonly<Record<string, string | boolean | undefined>> = {
    ...
    VITE_STELLAR_TESTNET_NETWORK_PASSPHRASE: import.meta.env.VITE_STELLAR_TESTNET_NETWORK_PASSPHRASE,
    ...
    VITE_STELLAR_TESTNET_JWK_REGISTRY_ADDRESS: import.meta.env.VITE_STELLAR_TESTNET_JWK_REGISTRY_ADDRESS,
    ...
    VITE_STELLAR_MAINNET_NETWORK_PASSPHRASE: import.meta.env.VITE_STELLAR_MAINNET_NETWORK_PASSPHRASE,
    ...
    VITE_STELLAR_MAINNET_JWK_REGISTRY_ADDRESS: import.meta.env.VITE_STELLAR_MAINNET_JWK_REGISTRY_ADDRESS,

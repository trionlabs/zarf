...
export const handle: Handle = async ({ event, resolve }) => {
    ...
    response.headers.set(
        ...
        `default-src 'self'; script-src 'self' 'wasm-unsafe-eval' 'unsafe-inline' blob: https://static.cloudflareinsights.com; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; font-src 'self' https://fonts.gstatic.com; ${connectSrc}; img-src 'self' data: https:; worker-src 'self' blob:; base-uri 'self'; form-action 'self';`,
    );

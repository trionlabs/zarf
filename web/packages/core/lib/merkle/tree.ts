 ...
 * (`contracts/soroban/zarf/airdrop/tests`). Runtime interoperability tests
 * feed these generated proofs into the actual Soroban contract, while compact
 * one known-answer root pins the external byte protocol (doc 09 §4, doc 06 §15).
 *
 * @module merkle/tree
 */

...
>
    ...
    <div class="relative z-30 text-center max-w-4xl px-6 flex flex-col items-center gap-5 md:gap-6">
        <!-- Eyebrow: Built on Stellar lockup. Entrance animation lives on the
             wrapper so the link's own hover transition isn't delayed with it. -->
        <div
            class="transition-all duration-700 ease-out {mounted
        ...
        >
            <a
                ...
                class="group inline-flex items-center gap-2 rounded-full border border-zen-fg/10 bg-zen-fg/[0.04] backdrop-blur-md pl-3.5 pr-4 py-1.5 transition-colors duration-300 hover:border-zen-fg/20 hover:bg-zen-fg/[0.07]"
            >
                <svg
                    class="w-3.5 h-3.5 fill-current text-zen-fg/70 transition-colors duration-300 group-hover:text-zen-fg"
                    viewBox="0 0 24 24"
                    aria-hidden="true"
                >
                    <path
                ...
                <span
                    class="text-[10px] font-semibold tracking-[0.28em] uppercase text-zen-fg/55 transition-colors duration-300 group-hover:text-zen-fg/80"
                >
                    Built on Stellar
                </span>
            </a>
        ...
        <!-- Honest status line — plain text; the Stellar mark now lives in the
             eyebrow lockup above, so it isn't repeated here. -->
        <p
        ...
        >
            Live on <span class="text-zen-fg/55">testnet</span>
        </p>
    </div>

...
>
    ...
    <div class="relative z-30 text-center max-w-4xl px-6 flex flex-col items-center gap-5 md:gap-6">
        <!-- Feature + Network Badges -->
        <div
            class="flex flex-wrap items-center justify-center gap-2 transition-all duration-700 ease-out {mounted
        ...
        >
            ...
            <a
                ...
                class="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-zen-fg/10 bg-zen-fg/5 backdrop-blur-md text-[11px] font-medium tracking-[0.15em] uppercase text-zen-fg/60 hover:text-zen-fg/90 transition-colors duration-300"
            >

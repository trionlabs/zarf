<script lang="ts">
    ...
    import { Mail, Wallet, Shield, Clock, Lock, Sparkles } from 'lucide-svelte';
    ...
    onMount(() => {
        const handleScroll = () => {
            ...
            if (scrollableDistance > 0) {
                ...
                activeIndex = Math.min(STEPS.length - 1, Math.floor(progress * STEPS.length));
            }
        };
...
-->
<section bind:this={sectionEl} class="relative" style="height: {(STEPS.length + 0.5) * 100}vh;">
            ...
            <div class="grid md:grid-cols-2 gap-8 md:gap-16 lg:gap-24 items-center">
                    ...
                    <div class="flex items-center gap-2.5 mb-8">
                        {#each STEPS as _, i (i)}
                            ...
                            >
                                ...
                                <div
                                    class="h-0.5 rounded-full transition-all duration-500 {activeIndex ===
                                    i
                        ...
                        {#each STEPS as step, i (step.title)}
                            <div
                                ...
                                style="
                                    ...
                                    transform: translateY({activeIndex === i
                                    ? 0
                                    : activeIndex > i
                                      ? -20
                                      : 20}px);
                ...
                <div class="order-1 md:order-2 flex justify-center">
                    <div class="relative w-full max-w-[260px] md:max-w-[340px] aspect-square">
                        <!-- Subtle Glow -->
                        <div
                            class="absolute inset-4 bg-base-content/[0.02] rounded-full blur-2xl scale-110"
                        ></div>
                        ...
                        <div class="relative w-full h-full">
                            {#each STEPS as _, i (i)}
                                <div
                                    ...
                                    style="
                                        opacity: {activeIndex === i ? 1 : 0};
                                        transform: scale({activeIndex === i
                                        ? 1
                                        : 0.97}) translateY({activeIndex === i
                                        ? 0
                                        : activeIndex > i
                                          ? -15
                                          : 15}px);
                                                ...
                                                {#each [0, 1, 2] as k (k)}
                                                    <div
                                                        ...
                                                        style="
                                                            ...
                                                            transform: translateY({activeIndex === 0
                                                            ? 0
                                                            : 12}px);
                                                    ...
                                                    >
                                                        ...
                                                        <div class="flex-1 space-y-1.5">
                                                            <div
                                                                class="h-1.5 bg-base-content/[0.06] rounded w-20"
                                                            ></div>
                                                            <div
                                                                class="h-1 bg-base-content/[0.04] rounded w-14"
                                                            ></div>
                                                        </div>
                                                    </div>
                                                {/each}
                                    ...
                                    {:else if i === 1}
                                        ...
                                        >
                                            <div
                                                ...
                                                style="
                                                    transform: translateY({activeIndex === 1
                                                    ? 0
                                                    : -15}px);
                                        ...
                                        >
                                            <div class="relative w-36 h-36">
                                                ...
                                                <div
                                                    ...
                                                    style="
                                                        transform: scale({activeIndex === 2
                                                        ? 1
                                                        : 0.85}) rotate({activeIndex === 2
                                                        ? 0
                                                        : -20}deg);
                                                ...
                                                <div
                                                    ...
                                                    style="
                                                        transform: translate({activeIndex === 2
                                                        ? 0
                                                        : 15}px, {activeIndex === 2 ? 0 : -8}px);
                                                        opacity: {activeIndex === 2 ? 1 : 0};
                                                        transition-delay: 160ms;
                                                    "
                                                >

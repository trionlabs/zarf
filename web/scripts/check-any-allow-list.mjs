...
const ALLOWLIST = {
    ...
    'packages/core/lib/zk/proof.worker.ts': [
        ...
        { content: 'let Noir: any;', reason: 'lazy binding for @noir-lang/noir_js dynamic import' },
        {
            content: 'let UltraHonkBackend: any;',
            reason: 'lazy binding for @aztec/bb.js dynamic import',
        },
        { content: 'let generateInputs: any;', reason: 'lazy binding for noir-jwt dynamic import' },
        {
        ...
        { content: 'publicKey: any; // JWK', reason: 'opaque JWK passed through from caller' },
        {
    ...
    'packages/core/lib/zk/index.ts': [
        { content: 'publicKey: any;', reason: 'JWK shape passed opaquely through to worker' },
        {
    ...
    'packages/core/lib/utils/domPreserve.ts': [
        ...
        {
            content: 'obj: any,',
            reason: 'Object.getOwnPropertyDescriptor patch param — must match lib.es5.d.ts (uses any)',
        },
        {
            content: 'get: function (this: any) {',

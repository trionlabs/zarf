...
<div class="h-full flex flex-col justify-center items-center max-w-2xl mx-auto py-12 text-center">
    
    <div class="w-24 h-24 bg-success/10 text-success rounded-full flex items-center justify-center mb-8" in:fly={{ y: 20, duration: 600 }}>
        <Check class="w-12 h-12" />
    </div>

    <h2 class="text-4xl font-light tracking-tight text-base-content mb-4" in:fly={{ y: 20, duration: 600, delay: 100 }}>
        Deployment Complete
    </h2>
    <p class="text-lg text-base-content/50 font-light tracking-wide mb-12" in:fly={{ y: 20, duration: 600, delay: 200 }}>
        Your vesting contract is live and ready for distribution.
    </p>

    <!-- Contract Address Box -->
    <div class="w-full bg-base-100/40 border border-base-content/10 rounded-2xl p-6 mb-12 relative group overflow-hidden" in:fly={{ y: 20, duration: 600, delay: 300 }}>
        ...
        <div class="flex flex-col gap-2">
            <span class="text-xs font-bold uppercase tracking-[0.2em] opacity-40">Contract Address</span>

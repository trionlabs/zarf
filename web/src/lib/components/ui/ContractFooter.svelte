...
<div
    class="fixed bottom-0 left-0 right-0 z-50 bg-neutral text-neutral-content text-xs font-mono shadow-lg opacity-90 hover:opacity-100 transition-opacity"
>
    <!-- Toggle Header -->
    <button
    ...
    {#if isOpen}
        <div
            class="p-2 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-2 border-t border-base-content/10"
        >
            {#each contracts as c}

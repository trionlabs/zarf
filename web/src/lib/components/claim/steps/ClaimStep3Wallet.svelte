<script lang="ts">
    ...
    // Optional: let balance = $derived(walletStore.balance);
        ...
        <div class="py-6 space-y-4">
            {#if isConnected && address}
                ...
                <p class="text-xs text-center text-base-content/40">
                    Switch accounts in your wallet if you wish to use a
                    different address.
                </p>
            {:else}
                <div
                ...
                >
                    ...
                    <!-- If ConnectButton component exists use it, else generic handler -->
                    <button
